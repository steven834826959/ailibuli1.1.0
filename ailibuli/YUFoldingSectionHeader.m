...
-(instancetype)initWithFrame:(CGRect)frame withTag:(NSInteger)tag
{
    ...
    if (self) {
        ...
        UIImage *image = [UIImage imageNamed:@"11@2x_02"];
...
-(void)setupSubviewsWithArrowPosition:(YUFoldingSectionHeaderArrowPosition)arrowPosition
{
    ...
    CGRect headerIconFrame = CGRectMake(YUFoldingMargin, 0, self.frame.size.height,self.frame.size.height);
    ...
    [self.headerIcon setFrame:headerIconFrame];
