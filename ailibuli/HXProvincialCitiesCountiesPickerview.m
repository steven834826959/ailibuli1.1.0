...
- (void)internalConfig {
    ...
    //背景色
    _headView.backgroundColor = [UIColor colorWithRed:11/255.0 green:89/255.0 blue:80/255.0 alpha:1.0];
    ...
    button.frame = CGRectMake(self.frame.size.width - 60, 0, 50, 43.5);
    button.backgroundColor = [UIColor clearColor];
    button.titleLabel.font = [UIFont systemFontOfSize:16];
    [button setTitleColor:[UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0] forState:UIControlStateNormal];
